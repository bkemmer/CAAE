...
if __name__ == '__main__':
    ...
    parser.add_argument('--batch-size', '--bs', dest='batch_size', default=100, type=int)
    ...
    ## *****
    consts.NUM_AGES = 6
    consts.NUM_GENDERS = 2
    consts.LABEL_LEN = consts.NUM_AGES + consts.NUM_GENDERS
    consts.NUM_GENDERS_EXPANDED=consts.NUM_GENDERS * (consts.NUM_AGES // consts.NUM_GENDERS)
    consts.LABEL_LEN_EXPANDED = consts.NUM_AGES + consts.NUM_GENDERS_EXPANDED
