...
def get_utkface_dataset(root):
    print('utils.py - get_utkface_dataset - root: ', root)
    ret = lambda: ImageFolder(root, transform=pil_to_model_tensor_transform)
    try:
        return ret()
...
class Label(namedtuple('Label', ('age', 'gender'))):
    ...
    def age_transform(age):
        ...
        '''
            Mudança de estratégica: dividimos os datasets em 6 grupos: 
            0: 11-20,
            1: 21-30,
            2: 31-40,
            3: 41-50,
